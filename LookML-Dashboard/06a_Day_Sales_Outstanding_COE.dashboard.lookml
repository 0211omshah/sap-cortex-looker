- dashboard: sap_coe_cortex_day_sales_outstanding
  title: "SAP COE Cortex - Accounts Receivable - Days Sales Outstanding"
  layout: newspaper
  ...
  - name: ''
    type: text
    title_text: ''
    subtitle_text: ' <a href="/dashboards/sap_coe_cortex::accounts_receivable?">Home</a>'
    body_text: ''
    row: 23
    col: 0
    width: 24
